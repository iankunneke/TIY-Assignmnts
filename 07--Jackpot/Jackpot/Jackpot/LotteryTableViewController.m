...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TicketNumber *ticket = [picks objectAtIndex: indexPath.row];
    
    cell.textLabel.text = [NSString stringWithFormat:@"%@ %@ %@ %@ %@ %@", [ticket.choices objectAtIndex:0], ticket.choices[1], ticket.choices[2], ticket.choices[3], ticket.choices[4], ticket.choices[5]];
...
- (IBAction)addTicket:(UIBarButtonItem *)sender
{
    TicketNumber *ticket = [TicketNumber ticketUsingPicker];
    [picks addObject: ticket];
